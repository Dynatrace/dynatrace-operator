...
func TestDeprecatedFeatureFlagsWarning(t *testing.T) {
	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureActiveGateAuthToken),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureActiveGateAuthToken))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureActiveGateReadOnlyFilesystem),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureActiveGateReadOnlyFilesystem))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureActiveGateRawImage),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureActiveGateRawImage))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureActiveGateUpdates),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureActiveGateUpdates))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureAutomaticK8sApiMonitoring),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureAutomaticK8sApiMonitoring))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureHostsRequests),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureHostsRequests))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureReadOnlyOneAgent),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureReadOnlyOneAgent))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureWebhookReinvocationPolicy),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureWebhookReinvocationPolicy))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureMetadataEnrichment),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureMetadataEnrichment))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureAutomaticInjection),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureAutomaticInjection))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationFeatureLabelVersionDetection),
		deprecationWarning(dynatracev1beta1.AnnotationFeatureLabelVersionDetection))

	assert.Equal(t, fmt.Sprintf("feature flag '%s' is deprecated and will be removed in the future as the feature will be enabled by default", dynatracev1beta1.AnnotationInjectionFailurePolicy),
