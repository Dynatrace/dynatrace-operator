...
func setAutTokenUsage(dynakube *dynatracev1.DynaKube, isUsed bool) {
	dynakube.Annotations[dynatracev1.AnnotationFeatureActiveGateAuthToken] = strconv.FormatBool(isUsed)
}
