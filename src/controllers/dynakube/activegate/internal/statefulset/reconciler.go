...
func (r *Reconciler) getDataFromCustomProperty(customProperties *dynatracev1beta1.StringValueSource) (string, error) {
...
func needsCustomPropertyHash(customProperties *dynatracev1beta1.StringValueSource) bool {
