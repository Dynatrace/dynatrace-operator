...
func (r *Reconciler) getDataFromCustomProperty(customProperties *dynatracev1beta1.ValueSource) (string, error) {
...
func needsCustomPropertyHash(customProperties *dynatracev1beta1.ValueSource) bool {
