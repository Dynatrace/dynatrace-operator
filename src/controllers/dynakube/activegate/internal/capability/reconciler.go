...
func NewReconciler(clt client.Client, capability capability.Capability, dynakube *dynatracev1beta1.DynaKube, statefulsetReconciler kubeobjects.Reconciler, customPropertiesReconciler kubeobjects.Reconciler) kubeobjects.Reconciler {
...
type NewReconcilerFunc = func(clt client.Client, capability capability.Capability, dynakube *dynatracev1beta1.DynaKube, statefulsetReconciler kubeobjects.Reconciler, customPropertiesReconciler kubeobjects.Reconciler) kubeobjects.Reconciler
