...
func updateNamespace(namespace *corev1.Namespace, deployedDynakubes *dynatracev1.DynaKubeList) (bool, error) {
...
func updateLabels(matches bool, dynakube *dynatracev1.DynaKube, namespace *corev1.Namespace) bool {
	updated := false
...
func isIgnoredNamespace(dk *dynatracev1.DynaKube, namespaceName string) bool {
