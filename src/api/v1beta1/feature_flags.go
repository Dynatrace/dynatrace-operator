...
// FeatureReadOnlyOneAgent is a feature flag to specify if the operator needs to deploy the oneagents in a readonly mode,
// where the csi-driver would provide the volume for logs and such
// Defaults to true
func (dk *DynaKube) FeatureReadOnlyOneAgent() bool {
	return dk.Annotations[AnnotationFeatureReadOnlyOneAgent] != "false"
}
