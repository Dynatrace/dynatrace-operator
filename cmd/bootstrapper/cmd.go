...
func AddFlags(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().StringSliceVar(&technologies, Technologies, []string{"all"}, "comma separated list of technologies that will be used to download the code modules image.")

	cmd.PersistentFlags().StringVar(&flavor, Flavor, arch.Flavor, "flavor of the code modules image.")
