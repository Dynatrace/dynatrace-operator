...
func TestOperatorManagerProvider(t *testing.T) {
	...
	t.Run("check if healthz/readyz checks are added", func(t *testing.T) {
		...
		testHealthzAndReadyz(t, mockMgr, func(mockMgr *mockedmanager.Manager) error {
...
func testHealthzAndReadyz(t *testing.T, mockMgr *mockedmanager.Manager, createProviderAndRunManager func(mockMgr *mockedmanager.Manager) error) {
