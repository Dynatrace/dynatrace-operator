...
func TestNewStatefulSetProperties(t *testing.T) {
	type args struct {
	...
	tests := []struct {
		name string
		args args
		want *statefulSetProperties
	}{
		// TODO: Add test cases.
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewStatefulSetProperties(tt.args.instance, tt.args.capabilityProperties, tt.args.kubeSystemUID, tt.args.customPropertiesHash, tt.args.feature, tt.args.capabilityName, tt.args.serviceAccountOwner); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewStatefulSetProperties() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestCreateStatefulSet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := CreateStatefulSet(tt.args.stsProperties)
			if (err != nil) != tt.wantErr {
				t.Errorf("CreateStatefulSet() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("CreateStatefulSet() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_buildTemplateSpec(t *testing.T) {
	type args struct {
		stsProperties *statefulSetProperties
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildTemplateSpec(tt.args.stsProperties); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildTemplateSpec() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_buildContainer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildContainer(tt.args.stsProperties); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildContainer() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_buildVolumes(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildVolumes(tt.args.stsProperties); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildVolumes() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_determineCustomPropertiesSource(t *testing.T) {
	type args struct {
		stsProperties *statefulSetProperties
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := determineCustomPropertiesSource(tt.args.stsProperties); got != tt.want {
				t.Errorf("determineCustomPropertiesSource() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_buildVolumeMounts(t *testing.T) {
	type args struct {
		stsProperties *statefulSetProperties
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildVolumeMounts(tt.args.stsProperties); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildVolumeMounts() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_buildEnvs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildEnvs(tt.args.stsProperties); !reflect.DeepEqual(got, tt.want) {
...
func Test_buildProxyEnv(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildProxyEnv(tt.args.proxy); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildProxyEnv() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_determineServiceAccountName(t *testing.T) {
	type args struct {
		stsProperties *statefulSetProperties
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := determineServiceAccountName(tt.args.stsProperties); got != tt.want {
				t.Errorf("determineServiceAccountName() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_buildKubernetesExpression(t *testing.T) {
	type args struct {
		archKey string
		osKey   string
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildKubernetesExpression(tt.args.archKey, tt.args.osKey); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("buildKubernetesExpression() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_isCustomPropertiesNilOrEmpty(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := isCustomPropertiesNilOrEmpty(tt.args.customProperties); got != tt.want {
				t.Errorf("isCustomPropertiesNilOrEmpty() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_isProxyNilOrEmpty(t *testing.T) {
	type args struct {
		proxy *dynatracev1alpha1.DynaKubeProxy
	}
	tests := []struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := isProxyNilOrEmpty(tt.args.proxy); got != tt.want {
				t.Errorf("isProxyNilOrEmpty() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_generateStatefulSetHash(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := generateStatefulSetHash(tt.args.sts)
			if (err != nil) != tt.wantErr {
				t.Errorf("generateStatefulSetHash() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("generateStatefulSetHash() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestHasStatefulSetChanged(t *testing.T) {
	type args struct {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := HasStatefulSetChanged(tt.args.a, tt.args.b); got != tt.want {
				t.Errorf("HasStatefulSetChanged() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestGetTemplateHash(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := GetTemplateHash(tt.args.a); got != tt.want {
				t.Errorf("GetTemplateHash() = %v, want %v", got, tt.want)
			}
		})
	}
}
