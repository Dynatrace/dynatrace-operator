...
// 	capability                       *dynatracev1alpha1.CapabilityProperties
...
// func (r *Reconciler) getDataFromCustomProperty(customProperties *dynatracev1alpha1.DynaKubeValueSource) (string, error) {
