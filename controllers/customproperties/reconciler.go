...
func NewReconciler(clt client.Client, instance *dynatracev1.DynaKube, log logr.Logger, customPropertiesOwnerName string, customPropertiesSource dynatracev1.DynaKubeValueSource, scheme *runtime.Scheme) *Reconciler {
	return &Reconciler{
		Client:                    clt,
		instance:                  instance,
		scheme:                    scheme,
