...
func Test_isAGTokensSecretEqual(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "equal",
			args: args{
				currentSecret: BuildAGTokensSecret(&dynatracev1alpha1.DynaKube{}, secretsData),
				desired:       secretsData,
			},
			want: true,
		},
		{
			...
			args: args{
				currentSecret: BuildAGTokensSecret(&dynatracev1alpha1.DynaKube{}, lessSecretsData),
				desired:       secretsData,
			},
			want: false,
		},
		{
			...
			args: args{
				currentSecret: BuildAGTokensSecret(&dynatracev1alpha1.DynaKube{}, moreSecretsData),
				desired:       secretsData,
			},
			want: false,
		},
		{
			...
			args: args{
				currentSecret: BuildAGTokensSecret(&dynatracev1alpha1.DynaKube{}, map[string][]byte{"other": []byte("data")}),
				desired:       secretsData,
			},
			want: false,
		},
