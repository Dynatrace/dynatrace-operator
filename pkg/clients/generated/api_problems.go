...
type ProblemsAPI interface {
	...
	*/
	CreateComment(ctx context.Context, problemId string) ApiCreateCommentRequest

	// CreateCommentExecute executes the request
	CreateCommentExecute(r ApiCreateCommentRequest) (*http.Response, error)
	...
	*/
	GetComment(ctx context.Context, problemId string, commentId string) ApiGetCommentRequest
	...
	*/
	GetComments(ctx context.Context, problemId string) ApiGetCommentsRequest

	// GetCommentsExecute executes the request
	//  @return CommentsList
	GetCommentsExecute(r ApiGetCommentsRequest) (*CommentsList, *http.Response, error)
	...
	*/
	GetProblem(ctx context.Context, problemId string) ApiGetProblemRequest

	// GetProblemExecute executes the request
	//  @return Problem
	GetProblemExecute(r ApiGetProblemRequest) (*Problem, *http.Response, error)
	...
	*/
	GetProblems(ctx context.Context) ApiGetProblemsRequest

	// GetProblemsExecute executes the request
	//  @return Problems
	GetProblemsExecute(r ApiGetProblemsRequest) (*Problems, *http.Response, error)
	...
	*/
	...
	UpdateCommentExecute(r ApiUpdateCommentRequest) (*http.Response, error)
}
