...
// MonitoredStates A list of process group instances and their monitoring states.
...
func (o *MonitoredStates) GetNextPageKey() string {
...
// and a boolean to check if the value has been set.
func (o *MonitoredStates) GetNextPageKeyOk() (*string, bool) {
	if o == nil || IsNil(o.NextPageKey) {
		return nil, false
	}
...
func (o *MonitoredStates) HasNextPageKey() bool {
	if o != nil && !IsNil(o.NextPageKey) {
		return true
	}
...
func (o *MonitoredStates) SetNextPageKey(v string) {
	o.NextPageKey = &v
}

// GetPageSize returns the PageSize field value if set, zero value otherwise.
func (o *MonitoredStates) GetPageSize() int32 {
...
// and a boolean to check if the value has been set.
func (o *MonitoredStates) GetPageSizeOk() (*int32, bool) {
	if o == nil || IsNil(o.PageSize) {
		return nil, false
	}
...
func (o *MonitoredStates) HasPageSize() bool {
	if o != nil && !IsNil(o.PageSize) {
		return true
	}
...
func (o *MonitoredStates) SetPageSize(v int32) {
	o.PageSize = &v
}
