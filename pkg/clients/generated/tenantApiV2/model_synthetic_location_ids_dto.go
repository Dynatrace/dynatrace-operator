...
type _SyntheticLocationIdsDto SyntheticLocationIdsDto
...
func (o *SyntheticLocationIdsDto) UnmarshalJSON(data []byte) (err error) {
	...
	varSyntheticLocationIdsDto := _SyntheticLocationIdsDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSyntheticLocationIdsDto)

	if err != nil {
		return err
	}

	*o = SyntheticLocationIdsDto(varSyntheticLocationIdsDto)
