...
func TestConvertFrom(t *testing.T) {
	...
	t.Run("migrate cloud-native from v1beta3 to v1beta3", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate application-monitoring from v1beta3 to v1beta3", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate activegate from v1beta3 to v1beta3", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate status from v1beta3 to v1beta3", func(t *testing.T) {
		from := getNewDynakubeBase()
...
func compareBase(t *testing.T, oldDk DynaKube, newDk v1beta3.DynaKube) {
...
func compareHostInjectSpec(t *testing.T, oldSpec HostInjectSpec, newSpec v1beta3.HostInjectSpec) {
...
func compareAppInjectionSpec(t *testing.T, oldSpec AppInjectionSpec, newSpec v1beta3.AppInjectionSpec) {
...
func compareCloudNativeSpec(t *testing.T, oldSpec CloudNativeFullStackSpec, newSpec v1beta3.CloudNativeFullStackSpec) {
...
func compareApplicationMonitoringSpec(t *testing.T, oldSpec ApplicationMonitoringSpec, newSpec v1beta3.ApplicationMonitoringSpec) {
	compareAppInjectionSpec(t, oldSpec.AppInjectionSpec, newSpec.AppInjectionSpec)
	assert.Equal(t, oldSpec.UseCSIDriver, newSpec.UseCSIDriver)
	assert.Equal(t, oldSpec.Version, newSpec.Version)
}

func compareActiveGateSpec(t *testing.T, oldSpec ActiveGateSpec, newSpec v1beta3.ActiveGateSpec) {
	assert.Equal(t, oldSpec.Annotations, newSpec.Annotations)
	assert.Equal(t, oldSpec.DNSPolicy, newSpec.DNSPolicy)
	assert.Equal(t, oldSpec.Env, newSpec.Env)
	assert.Equal(t, oldSpec.Image, newSpec.Image)
...
func compareStatus(t *testing.T, oldStatus DynaKubeStatus, newStatus v1beta3.DynaKubeStatus) {
	// Base
...
func getNewDynakubeBase() v1beta3.DynaKube {
	return v1beta3.DynaKube{
		...
		Spec: v1beta3.DynaKubeSpec{
			...
			MetadataEnrichment: v1beta3.MetadataEnrichment{
				Enabled:           true,
...
func getNewHostInjectSpec() v1beta3.HostInjectSpec {
	return v1beta3.HostInjectSpec{
...
func getNewAppInjectionSpec() v1beta3.AppInjectionSpec {
	return v1beta3.AppInjectionSpec{
...
func getNewCloudNativeSpec() v1beta3.CloudNativeFullStackSpec {
	return v1beta3.CloudNativeFullStackSpec{
		AppInjectionSpec: getNewAppInjectionSpec(),
		HostInjectSpec:   getNewHostInjectSpec(),
	}
}

func getNewApplicationMonitoringSpec() v1beta3.ApplicationMonitoringSpec {
	return v1beta3.ApplicationMonitoringSpec{
		AppInjectionSpec: getNewAppInjectionSpec(),
		UseCSIDriver:     true,
...
func getNewActiveGateSpec() v1beta3.ActiveGateSpec {
	return v1beta3.ActiveGateSpec{
		DNSPolicy: corev1.DNSClusterFirstWithHostNet,
		Annotations: map[string]string{
		...
		Capabilities: []v1beta3.CapabilityDisplayName{
			v1beta3.DynatraceApiCapability.DisplayName,
			v1beta3.KubeMonCapability.DisplayName,
			v1beta3.MetricsIngestCapability.DisplayName,
		},
		CapabilityProperties: v1beta3.CapabilityProperties{
			Labels: map[string]string{
			...
			CustomProperties: &v1beta3.DynaKubeValueSource{
...
func getNewStatus() v1beta3.DynaKubeStatus {
	return v1beta3.DynaKubeStatus{
		OneAgent: v1beta3.OneAgentStatus{
			...
			Instances: map[string]v1beta3.OneAgentInstance{
				"oa-instance-key-1": {
			...
			ConnectionInfoStatus: v1beta3.OneAgentConnectionInfoStatus{
				ConnectionInfoStatus: v1beta3.ConnectionInfoStatus{
					LastRequest: testTime,
					TenantUUID:  "oa-tenant-uuid",
					Endpoints:   "oa-endpoints",
				},
				CommunicationHosts: []v1beta3.CommunicationHostStatus{
					{
		...
		ActiveGate: v1beta3.ActiveGateStatus{
			VersionStatus: status.VersionStatus{
				ImageID:            "ag-image-id",
				Version:            "ag-version",
				Type:               "ag-image-type",
		...
		CodeModules: v1beta3.CodeModulesStatus{
			VersionStatus: status.VersionStatus{
				ImageID:            "cm-image-id",
				Version:            "cm-version",
				Type:               "cm-image-type",
		...
		DynatraceApi: v1beta3.DynatraceApiStatus{
