...
func (in *EdgeConnectSpec) DeepCopyInto(out *EdgeConnectSpec) {
	*out = *in
	...
	if in.KubernetesApiAutomation != nil {
		in, out := &in.KubernetesApiAutomation, &out.KubernetesApiAutomation
		*out = new(KubernetesApiAutomationSpec)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesApiAutomationSpec) DeepCopyInto(out *KubernetesApiAutomationSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesApiAutomationSpec.
func (in *KubernetesApiAutomationSpec) DeepCopy() *KubernetesApiAutomationSpec {
	if in == nil {
		return nil
	}
