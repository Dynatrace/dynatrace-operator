...
func (ag *Spec) SetDisableAutomaticTLSCertificate(disabled bool) {
	ag.disableAutomaticTLSCertificateEnabled = disabled
}
...
func (ag *Spec) IsAutomaticTlsSecretDisabled() bool {
	return ag.disableAutomaticTLSCertificateEnabled
}

func (ag *Spec) HasCaCert() bool {
	return ag.IsEnabled() && (ag.TlsSecretName != "" || !ag.IsAutomaticTlsSecretDisabled())
}
...
func (ag *Spec) GetTLSSecretName() string {
	...
	if !ag.IsAutomaticTlsSecretDisabled() {
