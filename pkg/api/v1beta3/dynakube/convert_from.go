...
// ConvertFrom converts from the Hub version (v1beta5) to this version (v1beta3).
func (dst *DynaKube) ConvertFrom(srcRaw conversion.Hub) error {
	src := srcRaw.(*dynakubev1beta5.DynaKube)
...
func (dst *DynaKube) fromBase(src *dynakubev1beta5.DynaKube) {
...
func (dst *DynaKube) fromLogMonitoringSpec(src *dynakubev1beta5.DynaKube) {
...
func (dst *DynaKube) fromKspmSpec(src *dynakubev1beta5.DynaKube) {
	if src.Spec.Kspm != nil {
		dst.Spec.Kspm = &kspm.Spec{}
	}
}

func (dst *DynaKube) fromExtensionsSpec(src *dynakubev1beta5.DynaKube) {
	if src.Spec.Extensions != nil {
		dst.Spec.Extensions = &ExtensionsSpec{}
	}
}

func (dst *DynaKube) fromOneAgentSpec(src *dynakubev1beta5.DynaKube) { //nolint:dupl
	switch {
...
func (dst *DynaKube) fromTemplatesSpec(src *dynakubev1beta5.DynaKube) {
...
func fromOpenTelemetryCollectorTemplate(src dynakubev1beta5.OpenTelemetryCollectorSpec) OpenTelemetryCollectorSpec {
...
func fromExtensionControllerTemplate(src dynakubev1beta5.ExtensionExecutionControllerSpec) ExtensionExecutionControllerSpec {
...
func (dst *DynaKube) fromActiveGateSpec(src *dynakubev1beta5.DynaKube) { //nolint:dupl
...
func (dst *DynaKube) fromStatus(src *dynakubev1beta5.DynaKube) {
...
func (dst *DynaKube) fromOneAgentStatus(src dynakubev1beta5.DynaKube) { //nolint:dupl
...
func (dst *DynaKube) fromActiveGateStatus(src dynakubev1beta5.DynaKube) {
...
func (dst *DynaKube) fromMetadataEnrichment(src *dynakubev1beta5.DynaKube) {
