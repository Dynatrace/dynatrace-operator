...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogModuleDaemonSetSpec) DeepCopyInto(out *LogModuleDaemonSetSpec) {
	*out = *in
	if in.Annotations != nil {
		in, out := &in.Annotations, &out.Annotations
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogModuleDaemonSetSpec.
func (in *LogModuleDaemonSetSpec) DeepCopy() *LogModuleDaemonSetSpec {
	if in == nil {
		return nil
	}
	out := new(LogModuleDaemonSetSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TemplatesSpec) DeepCopyInto(out *TemplatesSpec) {
	*out = *in
	...
	in.LogModuleDaemonSet.DeepCopyInto(&out.LogModuleDaemonSet)
}
