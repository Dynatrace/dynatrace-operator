...
const (
	...
	errorNodeSelectorConflict = `The DynaKube specification attempts to deploy a OneAgent or Standalone-LogMonitoring , which conflicts with another DynaKube's OneAgent or Standalone-LogMonitoring. Only one Agent per node is supported.
