...
func (in *CommonProperties) DeepCopyInto(out *CommonProperties) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommonProperties.
func (in *CommonProperties) DeepCopy() *CommonProperties {
	if in == nil {
		return nil
	}
	out := new(CommonProperties)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ExecutionControllerSpec) DeepCopyInto(out *ExecutionControllerSpec) {
	*out = *in
	...
	in.CommonProperties.DeepCopyInto(&out.CommonProperties)
}
