...
func (in *APIThrottler) DeepCopyInto(out *APIThrottler) {
	*out = *in
	in.LastRequestTimestamp.DeepCopyInto(&out.LastRequestTimestamp)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIThrottler.
func (in *APIThrottler) DeepCopy() *APIThrottler {
	if in == nil {
		return nil
	}
	out := new(APIThrottler)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TenantStatus) DeepCopyInto(out *TenantStatus) {
	*out = *in
	if in.APIThrottler != nil {
		in, out := &in.APIThrottler, &out.APIThrottler
		*out = new(APIThrottler)
		(*in).DeepCopyInto(*out)
	}
}
