...
func (in *APITokenStatus) DeepCopyInto(out *APITokenStatus) {
	*out = *in
	in.AvailableOptionalScopes.DeepCopyInto(&out.AvailableOptionalScopes)
	if in.Platform != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AvailableOptionalScopes) DeepCopyInto(out *AvailableOptionalScopes) {
	*out = *in
	if in.SettingsRead != nil {
		in, out := &in.SettingsRead, &out.SettingsRead
		*out = new(bool)
		**out = **in
	}
	if in.SettingsWrite != nil {
		in, out := &in.SettingsWrite, &out.SettingsWrite
		*out = new(bool)
		**out = **in
	}
}
...
func (in *AvailableOptionalScopes) DeepCopy() *AvailableOptionalScopes {
	if in == nil {
		return nil
	}
	out := new(AvailableOptionalScopes)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DynaKubeSpec) DeepCopyInto(out *DynaKubeSpec) {
	*out = *in
	...
	if in.EnableIstio != nil {
		in, out := &in.EnableIstio, &out.EnableIstio
		*out = new(bool)
		**out = **in
	}
}
