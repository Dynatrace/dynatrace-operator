...
func TestConvertTo(t *testing.T) {
	t.Run("migrate from v1beta5 to latest", func(t *testing.T) {
	...
	t.Run("migrate metadata-enrichment from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
		to := dynakubelatest.DynaKube{}
	...
	t.Run("migrate host-monitoring from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
	...
	t.Run("migrate application-monitoring from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
	...
	t.Run("migrate activegate from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
	...
	t.Run("migrate log-monitoring templates from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
	...
	t.Run("migrate status from v1beta5 to latest", func(t *testing.T) {
		from := getOldDynakubeBase()
...
func getOldExtensionExecutionControllerSpec() extensions.ExecutionControllerSpec {
	return extensions.ExecutionControllerSpec{
