...
func TestConvertFrom(t *testing.T) {
	t.Run("migrate base from latest to v1beta4", func(t *testing.T) {
	...
	t.Run("migrate metadata-enrichment from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
		to := DynaKube{}
	...
	t.Run("migrate host-monitoring from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate classic-fullstack from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
		hostSpec := getNewHostInjectSpec()
	...
	t.Run("migrate cloud-native from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate application-monitoring from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate activegate from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate log-monitoring from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate extensions templates from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate log-monitoring templates from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
	...
	t.Run("migrate status from latest to v1beta4", func(t *testing.T) {
		from := getNewDynakubeBase()
