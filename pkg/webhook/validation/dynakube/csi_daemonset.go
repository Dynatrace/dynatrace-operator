...
func missingCSIDaemonSet(ctx context.Context, dv *dynakubeValidator, dynakube *dynatracev1beta2.DynaKube) string {
...
func disabledCSIForReadonlyCSIVolume(_ context.Context, _ *dynakubeValidator, dynakube *dynatracev1beta2.DynaKube) string {
