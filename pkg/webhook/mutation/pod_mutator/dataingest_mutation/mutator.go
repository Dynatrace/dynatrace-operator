...
func (mutator *DataIngestPodMutator) Enabled(request *dtwebhook.BaseRequest) bool {
	enabledOnPod := utilmap.GetFieldBool(request.Pod.Annotations, dtwebhook.AnnotationDataIngestInject,
...
func (mutator *DataIngestPodMutator) Injected(request *dtwebhook.BaseRequest) bool {
	return utilmap.GetFieldBool(request.Pod.Annotations, dtwebhook.AnnotationDataIngestInjected, false)
}
