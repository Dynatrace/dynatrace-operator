...
func (mutator *DataIngestPodMutator) Enabled(request *dtwebhook.BaseRequest) bool {
	enabledOnPod := _map.GetFieldBool(request.Pod.Annotations, dtwebhook.AnnotationDataIngestInject,
...
func (mutator *DataIngestPodMutator) Injected(request *dtwebhook.BaseRequest) bool {
	return _map.GetFieldBool(request.Pod.Annotations, dtwebhook.AnnotationDataIngestInjected, false)
}
