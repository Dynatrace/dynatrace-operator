...
func TestMutate(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		for i := range request.Pod.Spec.Containers {
			...
			assert.True(t, containerIsInjected(request.Pod.Spec.Containers[i], false, false, false))
		}
...
func TestReinvoke(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		for i := range request.Pod.Spec.Containers {
			...
			if containerIsInjected(original.Pod.Spec.Containers[i], false, false, false) {
...
func TestAddOneAgentToContainer(t *testing.T) {
	...
	t.Run("add everything", func(t *testing.T) {
		...
		assert.True(t, containerIsInjected(container, false, false, false))
	})
}
