...
func TestIsPathIn(t *testing.T) {
	...
	t.Run("contains", func(t *testing.T) {
		assert.True(t, IsPathIn(mounts, "/mnt/vol1"))
	})

	t.Run("not contains", func(t *testing.T) {
		assert.False(t, IsPathIn(mounts, "/mnt/vol3"))
	})
}
...
func TestIsIn(t *testing.T) {
	...
	t.Run("contains", func(t *testing.T) {
		assert.True(t, IsIn(mounts, "vol1"))
	})

	t.Run("not contains", func(t *testing.T) {
		assert.False(t, IsIn(mounts, "vol3"))
	})
}
