...
func TestCreateSecretConfigForDynaKube(t *testing.T) {
	...
	t.Run("Create SecretConfig with tlsSecret", func(t *testing.T) {
		...
		expectedSecretConfig.OneAgentNoProxy = "https://$(DYNAKUBE_TEST_ACTIVEGATE_SERVICE_HOST):$(DYNAKUBE_TEST_ACTIVEGATE_SERVICE_PORT)/communication,https://dynakube-test-activegate.dynatrace-test:443/communication"
