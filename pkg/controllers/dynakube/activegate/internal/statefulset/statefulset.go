...
func (statefulSetBuilder Builder) buildVolumes() []corev1.Volume {
	...
	if !(statefulSetBuilder.dynakube.IsOTLPingestEnabled() || statefulSetBuilder.dynakube.IsTelemetryServiceEnabled()) || statefulSetBuilder.dynakube.Spec.ActiveGate.UseEphemeralVolume {
