...
type NewReconcilerFunc = func(clt client.Client, apiReader client.Reader, scheme *runtime.Scheme, dynakube *dynatracev1beta2.DynaKube, capability capability.Capability) controllers.Reconciler
