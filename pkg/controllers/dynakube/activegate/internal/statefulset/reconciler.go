...
func (r *Reconciler) getDataFromCustomProperty(ctx context.Context, customProperties *common.ValueSource) (string, error) {
...
func needsCustomPropertyHash(customProperties *common.ValueSource) bool {
