...
func NewReconciler(clt client.Client, instance *dynatracev1beta2.DynaKube, customPropertiesOwnerName string, scheme *runtime.Scheme, customPropertiesSource *dynatracev1beta2.DynaKubeValueSource) *Reconciler {
	return &Reconciler{
		client:                    clt,
		instance:                  instance,
		scheme:                    scheme,
