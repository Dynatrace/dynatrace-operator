...
func TestReconcileActiveGateCommunicationHosts(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		err = reconciler.ReconcileActiveGateCommunicationHosts(ctx, dynakubeV1beta3)
		require.NoError(t, err)
	...
	t.Run("verify removal of conditions", func(t *testing.T) {
		...
		err = r.ReconcileActiveGateCommunicationHosts(ctx, dynakubeV1beta3)
		require.NoError(t, err)
		...
		err = rec2.ReconcileActiveGateCommunicationHosts(ctx, dynakubeV1beta3)
		require.NoError(t, err)
