...
// newMockServiceReconciler creates a new instance of mockServiceReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockServiceReconciler(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockServiceReconciler {
...
// mockServiceReconciler is an autogenerated mock type for the serviceReconciler type
type mockServiceReconciler struct {
	mock.Mock
}

type mockServiceReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockServiceReconciler) EXPECT() *mockServiceReconciler_Expecter {
	return &mockServiceReconciler_Expecter{mock: &_m.Mock}
}

// Reconcile provides a mock function for the type mockServiceReconciler
func (_mock *mockServiceReconciler) Reconcile(ctx context.Context, dk *dynakube.DynaKube) error {
	ret := _mock.Called(ctx, dk)
...
// mockServiceReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockServiceReconciler_Reconcile_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - dk *dynakube.DynaKube
func (_e *mockServiceReconciler_Expecter) Reconcile(ctx any, dk any) *mockServiceReconciler_Reconcile_Call {
	return &mockServiceReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, dk)}
}

func (_c *mockServiceReconciler_Reconcile_Call) Run(run func(ctx context.Context, dk *dynakube.DynaKube)) *mockServiceReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockServiceReconciler_Reconcile_Call) Return(err error) *mockServiceReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockServiceReconciler_Reconcile_Call) RunAndReturn(run func(ctx context.Context, dk *dynakube.DynaKube) error) *mockServiceReconciler_Reconcile_Call {
	_c.Call.Return(run)
	return _c
}
