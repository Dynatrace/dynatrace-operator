...
// newMockExtensionDynakubeReconciler creates a new instance of mockExtensionDynakubeReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockExtensionDynakubeReconciler(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockExtensionDynakubeReconciler {
	mock := &mockExtensionDynakubeReconciler{}
	mock.Mock.Test(t)
...
// mockExtensionDynakubeReconciler is an autogenerated mock type for the extensionDynakubeReconciler type
type mockExtensionDynakubeReconciler struct {
	mock.Mock
}

type mockExtensionDynakubeReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockExtensionDynakubeReconciler) EXPECT() *mockExtensionDynakubeReconciler_Expecter {
	return &mockExtensionDynakubeReconciler_Expecter{mock: &_m.Mock}
}

// Reconcile provides a mock function for the type mockExtensionDynakubeReconciler
func (_mock *mockExtensionDynakubeReconciler) Reconcile(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error {
...
// mockExtensionDynakubeReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockExtensionDynakubeReconciler_Reconcile_Call struct {
	*mock.Call
}
...
//   - dk *dynakube.DynaKube
func (_e *mockExtensionDynakubeReconciler_Expecter) Reconcile(ctx any, imageClient any, dk any) *mockExtensionDynakubeReconciler_Reconcile_Call {
	return &mockExtensionDynakubeReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, imageClient, dk)}
}

func (_c *mockExtensionDynakubeReconciler_Reconcile_Call) Run(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube)) *mockExtensionDynakubeReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockExtensionDynakubeReconciler_Reconcile_Call) Return(err error) *mockExtensionDynakubeReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockExtensionDynakubeReconciler_Reconcile_Call) RunAndReturn(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error) *mockExtensionDynakubeReconciler_Reconcile_Call {
	_c.Call.Return(run)
	return _c
}
