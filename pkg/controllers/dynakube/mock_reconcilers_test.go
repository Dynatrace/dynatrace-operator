...
// newMockExtensionReconciler creates a new instance of mockExtensionReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockExtensionReconciler(t interface {
	mock.TestingT
	Cleanup(func())
...
// mockExtensionReconciler is an autogenerated mock type for the extensionReconciler type
type mockExtensionReconciler struct {
	mock.Mock
}

type mockExtensionReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockExtensionReconciler) EXPECT() *mockExtensionReconciler_Expecter {
	return &mockExtensionReconciler_Expecter{mock: &_m.Mock}
}

// Reconcile provides a mock function for the type mockExtensionReconciler
func (_mock *mockExtensionReconciler) Reconcile(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error {
	ret := _mock.Called(ctx, imageClient, dk)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, image.Client, *dynakube.DynaKube) error); ok {
		r0 = returnFunc(ctx, imageClient, dk)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// mockExtensionReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockExtensionReconciler_Reconcile_Call struct {
	*mock.Call
}
...
//   - dk *dynakube.DynaKube
func (_e *mockExtensionReconciler_Expecter) Reconcile(ctx any, imageClient any, dk any) *mockExtensionReconciler_Reconcile_Call {
	return &mockExtensionReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, imageClient, dk)}
}

func (_c *mockExtensionReconciler_Reconcile_Call) Run(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube)) *mockExtensionReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 image.Client
		if args[1] != nil {
			arg1 = args[1].(image.Client)
		}
...
func (_c *mockExtensionReconciler_Reconcile_Call) Return(err error) *mockExtensionReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockExtensionReconciler_Reconcile_Call) RunAndReturn(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error) *mockExtensionReconciler_Reconcile_Call {
	_c.Call.Return(run)
	return _c
}

// newMockOTelColReconciler creates a new instance of mockOTelColReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockOTelColReconciler(t interface {
	mock.TestingT
	Cleanup(func())
...
// mockOTelColReconciler is an autogenerated mock type for the oTelColReconciler type
type mockOTelColReconciler struct {
	mock.Mock
}

type mockOTelColReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockOTelColReconciler) EXPECT() *mockOTelColReconciler_Expecter {
	return &mockOTelColReconciler_Expecter{mock: &_m.Mock}
}

// Reconcile provides a mock function for the type mockOTelColReconciler
func (_mock *mockOTelColReconciler) Reconcile(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error {
	ret := _mock.Called(ctx, imageClient, dk)
...
// mockOTelColReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockOTelColReconciler_Reconcile_Call struct {
	*mock.Call
}
...
//   - imageClient image.Client
//   - dk *dynakube.DynaKube
func (_e *mockOTelColReconciler_Expecter) Reconcile(ctx any, imageClient any, dk any) *mockOTelColReconciler_Reconcile_Call {
	return &mockOTelColReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, imageClient, dk)}
}

func (_c *mockOTelColReconciler_Reconcile_Call) Run(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube)) *mockOTelColReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockOTelColReconciler_Reconcile_Call) Return(err error) *mockOTelColReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockOTelColReconciler_Reconcile_Call) RunAndReturn(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error) *mockOTelColReconciler_Reconcile_Call {
	_c.Call.Return(run)
	return _c
}
...
// newMockKubemonReconciler creates a new instance of mockKubemonReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockKubemonReconciler(t interface {
	mock.TestingT
	Cleanup(func())
...
// mockKubemonReconciler is an autogenerated mock type for the kubemonReconciler type
type mockKubemonReconciler struct {
	mock.Mock
}

type mockKubemonReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockKubemonReconciler) EXPECT() *mockKubemonReconciler_Expecter {
	return &mockKubemonReconciler_Expecter{mock: &_m.Mock}
}
...
// mockKubemonReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockKubemonReconciler_Reconcile_Call struct {
	*mock.Call
}
...
func (_c *mockKubemonReconciler_Reconcile_Call) Return(err error) *mockKubemonReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}
