...
// newMockOtelcReconciler creates a new instance of mockOtelcReconciler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockOtelcReconciler(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockOtelcReconciler {
	mock := &mockOtelcReconciler{}
	mock.Mock.Test(t)
...
// mockOtelcReconciler is an autogenerated mock type for the otelcReconciler type
type mockOtelcReconciler struct {
	mock.Mock
}

type mockOtelcReconciler_Expecter struct {
	mock *mock.Mock
}

func (_m *mockOtelcReconciler) EXPECT() *mockOtelcReconciler_Expecter {
	return &mockOtelcReconciler_Expecter{mock: &_m.Mock}
}

// Reconcile provides a mock function for the type mockOtelcReconciler
func (_mock *mockOtelcReconciler) Reconcile(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error {
...
// mockOtelcReconciler_Reconcile_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Reconcile'
type mockOtelcReconciler_Reconcile_Call struct {
	*mock.Call
}
...
//   - dk *dynakube.DynaKube
func (_e *mockOtelcReconciler_Expecter) Reconcile(ctx any, imageClient any, dk any) *mockOtelcReconciler_Reconcile_Call {
	return &mockOtelcReconciler_Reconcile_Call{Call: _e.mock.On("Reconcile", ctx, imageClient, dk)}
}

func (_c *mockOtelcReconciler_Reconcile_Call) Run(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube)) *mockOtelcReconciler_Reconcile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *mockOtelcReconciler_Reconcile_Call) Return(err error) *mockOtelcReconciler_Reconcile_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockOtelcReconciler_Reconcile_Call) RunAndReturn(run func(ctx context.Context, imageClient image.Client, dk *dynakube.DynaKube) error) *mockOtelcReconciler_Reconcile_Call {
	_c.Call.Return(run)
	return _c
}
