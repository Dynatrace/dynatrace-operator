...
func TestTokens(t *testing.T) {
	t.Run("empty dynakube, all permissions in api token, but paas => should fail", func(t *testing.T) {
		...
		err := tokens.VerifyScopes(context.Background(), createFakeClient(t), dynatracev1beta1.DynaKube{})
...
func enableKubernetesMonitoringAndMetricsIngest(dynakube *dynatracev1beta1.DynaKube) *dynatracev1beta1.DynaKube {
	dynakube.Spec.ActiveGate.Capabilities = []dynatracev1beta1.CapabilityDisplayName{
		dynatracev1beta1.KubeMonCapability.DisplayName,
