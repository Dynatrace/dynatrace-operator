...
func (updater codeModulesUpdater) LatestImageInfo(ctx context.Context) (*image.LatestImageInfo, error) {
	imgInfo, err := updater.dtClient.AsV2().Image.LatestCodeModulesImage(ctx)
	if err != nil {
