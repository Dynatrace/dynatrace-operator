...
func (updater activeGateUpdater) LatestImageInfo(ctx context.Context) (*image.LatestImageInfo, error) {
	imageInfo, err := updater.dtClient.AsV2().Image.LatestActiveGateImage(ctx)
	if err != nil {
