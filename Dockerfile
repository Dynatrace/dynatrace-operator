...
FROM --platform=$TARGETPLATFORM registry.access.redhat.com/ubi9-micro:9.7-1777857794@sha256:e0b6e93fe3800bf75a3e95aaf63bdfd020ea6dc30a92ca4bfa0021fa28cd671a AS base
