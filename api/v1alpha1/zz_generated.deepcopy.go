...
func (in *DynaKubeSpec) DeepCopyInto(out *DynaKubeSpec) {
	*out = *in
	...
	in.MintSpec.DeepCopyInto(&out.MintSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MintSpec) DeepCopyInto(out *MintSpec) {
	*out = *in
	in.CapabilityProperties.DeepCopyInto(&out.CapabilityProperties)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MintSpec.
func (in *MintSpec) DeepCopy() *MintSpec {
	if in == nil {
		return nil
	}
	out := new(MintSpec)
