...
if [ "${PLATFORM}" = "openshift" ]; then
  # shellcheck disable=SC2129
	echo 'LABEL com.redhat.openshift.versions="v4.9-v4.14"' >> "./config/olm/${PLATFORM}/bundle-${VERSION}.Dockerfile"
	...
	echo '  com.redhat.openshift.versions: v4.9-v4.14' >> "./config/olm/${PLATFORM}/${VERSION}/metadata/annotations.yaml"
fi
