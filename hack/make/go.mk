...
go/test: manifests/kubernetes manifests/openshift go/fmt swagger/generate-rest-client
...
go/run: manifests/kubernetes manifests/openshift go/fmt go/vet swagger/generate-rest-client
	go run ./src/cmd/operator/

## Builds the Operators binary and writes it to bin/manager
go/build/manager: manifests/crd/generate go/fmt go/vet swagger/generate-rest-client
...
go/build/manager/amd64: manifests/crd7generate go/fmt go/vet swagger/generate-rest-client
