...
manifests/crd/generate: prerequisites/controller-gen
	...
	$(CONTROLLER_GEN) "$(CRD_KEEP_DESC)" $(CRD_PATHS_KEEP_DESC) output:crd:artifacts:config=config/crd/bases
...
manifests/crd/install: prerequisites/kustomize manifests/crd/generate
	...
	$(KUSTOMIZE) build config/crd/prometheusmonitoring | kubectl apply -f -
...
manifests/crd/uninstall: prerequisites/kustomize manifests/crd/generate
	...
	$(KUSTOMIZE) build config/crd/prometheusmonitoring | kubectl delete -f -
...
manifests/crd/helm: prerequisites/kustomize helm/version manifests/crd/generate
	...
	./hack/helm/generate-crd.sh $(KUSTOMIZE) $(HELM_CRD_DIR) $(MANIFESTS_DIR) config/crd/prometheusmonitoring dynatrace-operator-prometheusmonitoring-crd.yaml enablePrometheus
