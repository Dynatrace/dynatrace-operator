...
doc/api-ref: manifests prerequisites/python
	source local/.venv/bin/activate && python3 ./hack/doc/custom_resource_params_to_md.py ./config/crd/longdescbases/dynatrace.com_dynakubes.yaml > ./doc/api/dynakube-api-ref.md
	source local/.venv/bin/activate && python3 ./hack/doc/custom_resource_params_to_md.py ./config/crd/longdescbases/dynatrace.com_edgeconnects.yaml > ./doc/api/edgeconnect-api-ref.md
