...
func WithProxyCA(t *testing.T, proxySpec *value.Source) features.Feature {
	...
	cloudnative.AssessSampleContainer(builder, sampleApp, func() []byte { return nil }, trustedCa)
	cloudnative.AssessOneAgentContainer(builder, func() []byte { return nil }, trustedCa)
