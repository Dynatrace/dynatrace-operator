...
// IsContainerInjected provides a mock function with given fields: container
func (_m *PodMutator) IsContainerInjected(container v1.Container) bool {
	ret := _m.Called(container)

	if len(ret) == 0 {
		panic("no return value specified for IsContainerInjected")
	}

	var r0 bool
	if rf, ok := ret.Get(0).(func(v1.Container) bool); ok {
		r0 = rf(container)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
// PodMutator_IsContainerInjected_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsContainerInjected'
type PodMutator_IsContainerInjected_Call struct {
	*mock.Call
}

// IsContainerInjected is a helper method to define mock.On call
//   - container v1.Container
func (_e *PodMutator_Expecter) IsContainerInjected(container interface{}) *PodMutator_IsContainerInjected_Call {
	return &PodMutator_IsContainerInjected_Call{Call: _e.mock.On("IsContainerInjected", container)}
}

func (_c *PodMutator_IsContainerInjected_Call) Run(run func(container v1.Container)) *PodMutator_IsContainerInjected_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(v1.Container))
	})
	return _c
}

func (_c *PodMutator_IsContainerInjected_Call) Return(_a0 bool) *PodMutator_IsContainerInjected_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PodMutator_IsContainerInjected_Call) RunAndReturn(run func(v1.Container) bool) *PodMutator_IsContainerInjected_Call {
	_c.Call.Return(run)
	return _c
}
