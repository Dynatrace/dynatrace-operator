...
import (
	...
	v1alpha1edgeconnect "github.com/Dynatrace/dynatrace-operator/pkg/api/v1alpha1/edgeconnect"
)
...
func (_m *Client) CreateEdgeConnect(name string, hostPatterns []string, hostMappings []v1alpha1edgeconnect.HostMapping, oauthClientId string) (edgeconnect.CreateResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []string, []v1alpha1edgeconnect.HostMapping, string) (edgeconnect.CreateResponse, error)); ok {
		return rf(name, hostPatterns, hostMappings, oauthClientId)
	}
	if rf, ok := ret.Get(0).(func(string, []string, []v1alpha1edgeconnect.HostMapping, string) edgeconnect.CreateResponse); ok {
		r0 = rf(name, hostPatterns, hostMappings, oauthClientId)
	} else {
		r0 = ret.Get(0).(edgeconnect.CreateResponse)
	}

	if rf, ok := ret.Get(1).(func(string, []string, []v1alpha1edgeconnect.HostMapping, string) error); ok {
...
//   - name string
//   - hostPatterns []string
//   - hostMappings []v1alpha1edgeconnect.HostMapping
...
func (_c *Client_CreateEdgeConnect_Call) Run(run func(name string, hostPatterns []string, hostMappings []v1alpha1edgeconnect.HostMapping, oauthClientId string)) *Client_CreateEdgeConnect_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string), args[2].([]v1alpha1edgeconnect.HostMapping), args[3].(string))
	})
	return _c
}
...
func (_c *Client_CreateEdgeConnect_Call) RunAndReturn(run func(string, []string, []v1alpha1edgeconnect.HostMapping, string) (edgeconnect.CreateResponse, error)) *Client_CreateEdgeConnect_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) UpdateEdgeConnect(edgeConnectId string, name string, hostPatterns []string, hostMappings []v1alpha1edgeconnect.HostMapping, oauthClientId string) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, []string, []v1alpha1edgeconnect.HostMapping, string) error); ok {
...
func (_c *Client_UpdateEdgeConnect_Call) Run(run func(edgeConnectId string, name string, hostPatterns []string, hostMappings []v1alpha1edgeconnect.HostMapping, oauthClientId string)) *Client_UpdateEdgeConnect_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(string), args[2].([]string), args[3].([]v1alpha1edgeconnect.HostMapping), args[4].(string))
	})
	return _c
}
...
func (_c *Client_UpdateEdgeConnect_Call) RunAndReturn(run func(string, string, []string, []v1alpha1edgeconnect.HostMapping, string) error) *Client_UpdateEdgeConnect_Call {
	_c.Call.Return(run)
	return _c
}
