...
func ImageVolumeNoCSI(t *testing.T) features.Feature {
	...
	builder.Assess("check injection of pods with random user", checkImageVolumeInjection(randomUserSample))
...
func checkImageVolumeInjection(deployment *sample.App) features.Func {
