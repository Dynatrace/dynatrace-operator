...
func InstallOperatorFromSource(builder *features.FeatureBuilder, testDynakube dynatracev1.DynaKube) {
...
func InstallOperatorFromSourceWithCustomNamespace(builder *features.FeatureBuilder, operatorNamespace corev1.Namespace, testDynakube dynatracev1.DynaKube) {
...
func InstallOperatorFromRelease(builder *features.FeatureBuilder, testDynakube dynatracev1.DynaKube, releaseTag string) {
...
func verifyOperatorDeployment(builder *features.FeatureBuilder, testDynakube dynatracev1.DynaKube) {
